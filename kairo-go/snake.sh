...
#     - Arrow key controls
#     - Auto-restart 2.5s after death
#     - Quit functionality that returns to Kairo Go TUI
...
game_loop() {
    ...
    echo -e "${text_color}Oh, No! You 0xdead$no_color ${text_color} Replay by typing /root/kairo-go/snake.sh"
